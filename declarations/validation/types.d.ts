...
export type ValidatorBuilder<T, Model extends object, Context extends object, OptionsShape extends object> = (binding: Binding<Model>, context: Context) => Validator<T, Model, OptionsShape, Context>;
export interface Validator<T, Model extends object, Context extends object, OptionsShape extends BaseOptions> {
    validate(this: BaseValidator<T, Model, Context, OptionsShape>, value: T, options: OptionsShape, context: Context | Model): ValidateFnResponse;
