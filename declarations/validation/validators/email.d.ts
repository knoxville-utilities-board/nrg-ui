...
export default class EmailValidator<Model extends object, Context extends object = Record<string, unknown>> extends BaseValidator<string | null | undefined, Model, Context, EmailOptions> {
