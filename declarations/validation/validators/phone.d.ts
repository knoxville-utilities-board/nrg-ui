...
export default class PhoneValidator<Model extends object, Context extends object = Record<string, unknown>> extends BaseValidator<string | null | undefined, Model, Context, PhoneOptions> {
    defaultOptions: {
        areaCode: "allow";
        countryCode: "allow";
    };
