...
export default class PasswordValidator<Context extends object = Record<string, unknown>, Model extends object = Record<string, unknown>> extends BaseValidator<string, Model, Context, PasswordOptions> {
    defaultOptions: {
