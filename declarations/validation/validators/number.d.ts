...
export default class NumberValidator<Model extends object, Context extends object = Record<string, unknown>> extends BaseValidator<NumberLike, Model, Context, NumberOptions> {
    defaultOptions: {
        allowNone: boolean;
    };
