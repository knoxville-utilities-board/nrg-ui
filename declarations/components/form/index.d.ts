...
export type ValidatorArray = ValidatorBuilder<unknown, object, object, object>[];
export type ValidatorsObject = Record<string, ValidatorBuilder<unknown, object, object, object> | ValidatorArray>;
