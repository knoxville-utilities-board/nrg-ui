...
export default class ButtonGroupDemo extends Component {
  ...
  <template>
    <Section @name="Button group" as |Section|>
      ...
      <Section.Subsection
        @name="Button group with a sub group"
        @model={{this}}
        @elementTag="button"
      >
        <:example as |model|>
          ...
          >
            ...
            >
              <SubGroup.Button
                class={{this.buttonClass "Sub Option 1"}}
                @disabled={{model.disabled}}
                @text="Sub Option 1"
                @onClick={{fn this.onButtonClick "Sub Option 1"}}
              />
              <SubGroup.Button
                class={{this.buttonClass "Sub Option 2"}}
                @disabled={{model.disabled}}
                @text="Sub Option 2"
                @onClick={{fn this.onButtonClick "Sub Option 2"}}
              />
              <SubGroup.Button
                class={{this.buttonClass "Sub Option 3"}}
                @disabled={{model.disabled}}
                @text="Sub Option 3"
                @onClick={{fn this.onButtonClick "Sub Option 3"}}
              />
            </Group.SubGroup>
            <Group.Button
              class={{this.buttonClass "Option 1"}}
