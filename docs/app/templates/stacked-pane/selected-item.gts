...
export default <template><StackedPane @previousRoute="stacked-pane">
  <div class="card">
    <div class="card-body">
    ...
    <div class="card-body">
      ...
      <ul class="list-group">
        <LinkTo class="list-group-item" @route="stacked-pane.selected-item.selected-subitem" @model={{6}}>
          <div class="d-flex w-100 justify-content-between">
            <h5 class="mb-1">Address 6</h5>
          </div>
          <p class="mb-1">City, State Zip</p>
        </LinkTo>
        <LinkTo class="list-group-item" @route="stacked-pane.selected-item.selected-subitem" @model={{7}}>

          <div class="d-flex w-100 justify-content-between">
            <h5 class="mb-1">Address 7</h5>
          </div>
          <p class="mb-1">City, State Zip</p></LinkTo>
        <LinkTo class="list-group-item" @route="stacked-pane.selected-item.selected-subitem" @model={{8}}>
          <div class="d-flex w-100 justify-content-between">
            <h5 class="mb-1">Address 8</h5>
          </div>
          <p class="mb-1">City, State Zip</p></LinkTo>
        <LinkTo class="list-group-item" @route="stacked-pane.selected-item.selected-subitem" @model={{9}}>
          <div class="d-flex w-100 justify-content-between">
            <h5 class="mb-1">Address 9</h5>
          </div>
          <p class="mb-1">City, State Zip</p></LinkTo>
        <LinkTo class="list-group-item" @route="stacked-pane.selected-item.selected-subitem" @model={{10}}>
          <div class="d-flex w-100 justify-content-between">
