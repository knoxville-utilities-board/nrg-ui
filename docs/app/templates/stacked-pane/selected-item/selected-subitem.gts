...
export default <template><StackedPane @previousRoute="stacked-pane.selected-item">
  <div class="card">
    <div class="card-body">
    ...
    <div class="card-body">
      ...
      <ul class="list-group">
        <LinkTo class="list-group-item" @route="stacked-pane.selected-item.selected-subitem.selected-subitem-2" @model="Electric">
          <div class="d-flex w-100 justify-content-between">
            <h5 class="mb-1">Electric</h5>
          </div>
        </LinkTo>
        <LinkTo class="list-group-item" @route="stacked-pane.selected-item.selected-subitem.selected-subitem-2" @model="Water">
          <div class="d-flex w-100 justify-content-between">
            <h5 class="mb-1">Water</h5>
          </div>
        </LinkTo>
        <LinkTo class="list-group-item" @route="stacked-pane.selected-item.selected-subitem.selected-subitem-2" @model="Gas">
          <div class="d-flex w-100 justify-content-between">
