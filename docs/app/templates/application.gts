...
export default <template>{{pageTitle "@nrg-ui/core"}}
...
<Scaffold @environment={{@controller.environment}}>
  ...
  <:footer-left>
    <a aria-label="Knoxville Utilities Board" class="p-0 d-none d-md-block" href="https://www.kub.org/">
...
{{!-- END-SNIPPET --}}</template> satisfies TemplateOnlyComponent<{ Args: { model: unknown, controller: unknown } }>