...
import type StackedPaneController from '../controllers/stacked-pane.ts';
...
const StackedPaneTemplate: TOC<StackedPaneSignature> = <template>
  ...
  <div class="row g-0">
    <div class="col px-md-0 py-3">
      <div class="container mx-auto">
        {{#let (codeSnippet "stacked-pane-component") as |snippet|}}
  ...
  <div class="row g-0">
    <div class="col px-md-0 py-3">
      <div class="container mx-auto">
        {{#let (codeSnippet "stacked-pane-controller") as |snippet|}}
          <CodeBlock @lang="typescript" @code={{snippet.code}} />
        {{/let}}
        {{#let (codeSnippet "stacked-pane-pagination-component") as |snippet|}}
          <CodeBlock @lang="glimmer-template" @code={{snippet.code}} />
        {{/let}}
      </div>
    </div>
