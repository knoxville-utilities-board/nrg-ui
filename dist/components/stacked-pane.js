...
class Pane extends Component {
  ...
  static {
    setComponentTemplate(precompileTemplate("\n    <div class={{classes \"stacked-pane p-2\" (if (eq this.ratio \"focused\") \"focused\") (if (eq this.ratio \"half\") \"half\") (if (eq this.ratio \"full\") \"full\") (if @placeholder \"d-none d-md-block\")}} ...attributes>\n      {{#if @previousRoute}}\n        <div class=\"d-block d-md-none\">\n          <LinkTo @route={{@previousRoute}} class=\"icon-link icon-link-hover p-1\">\n            <i class=\"bi bi-arrow-left\"></i>\n            {{t \"nrg.stacked-pane.navigate-back\"}}\n          </LinkTo>\n        </div>\n      {{/if}}\n      {{yield}}\n    </div>\n  ", {
      strictMode: true,
      scope: () => ({
        classes,
        eq,
