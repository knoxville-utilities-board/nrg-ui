...
class Form extends Component {
  ...
  static {
    setComponentTemplate(precompileTemplate("\n    <form {{on \"submit\" (perform this.submit)}} {{onInsert this.setElement}} ...attributes>\n      {{yield (hash Field=(component Field disabled=@disabled form=this) SubmitButton=(component Button _class=this.submitButtonClass disabled=@disabled loading=this.loading text=\"Submit\" type=\"submit\"))}}\n    </form>\n  ", {
      strictMode: true,
      scope: () => ({
        on,
        perform,
