...
class Search extends BoundValue {
  ...
  static {
    setComponentTemplate(precompileTemplate("\n    <Dropdown @fullWidth={{true}} @side={{@side}} @onShow={{@onShow}} @onHide={{@onHide}} {{onInsert this.onMenuInsert}}>\n      <:control as |visibility|>\n        <div class={{classes \"search\" (if @isInvalid \"is-invalid\") (if @isWarning \"is-warning\")}} {{onInsert (fn this.setVisibility visibility)}} ...attributes>\n          <div class=\"input-group\">\n            {{#unless this.hideSearchIcon}}\n              <span class=\"input-group-text\">\n                {{#if this.loading}}\n                  <span class=\"spinner-border spinner-border-sm\" />\n                {{else}}\n                  <i class=\"bi bi-search\" />\n                {{/if}}\n              </span>\n            {{/unless}}\n            <TextInput class={{this.inputClassList}} placeholder={{this.placeholder}} @basic={{@basic}} @binding={{bind this.self (if visibility.isShown \"searchString\" \"displayValue\")}} @disabled={{@disabled}} @id={{@id}} @readonly={{@readonly}} {{on \"input\" this.onSearch}} {{on \"focus\" visibility.show}} {{onKey \"ArrowUp\" this.moveUp onlyWhenFocused=true}} {{onKey \"ArrowDown\" this.moveDown onlyWhenFocused=true}} {{onKey \"Enter\" this.enterKeyHandler onlyWhenFocused=true}} {{onKey \"NumpadEnter\" this.enterKeyHandler onlyWhenFocused=true}} {{onKey \"Tab\" this.exitKeyHandler onlyWhenFocused=true}} {{onKey \"Escape\" this.exitKeyHandler onlyWhenFocused=true}} {{onInsert this.onSearchBarInsert}} />\n            {{#if this.clearable}}\n              <Button aria-label={{t \"nrg.base.clear\"}} class=\"btn-outline-secondary\" @onClick={{this.clear}}>\n                <i class=\"bi bi-x-lg\" />\n              </Button>\n            {{/if}}\n          </div>\n        </div>\n      </:control>\n      <:menu as |Menu|>\n        {{#each this.internalOptions as |option index|}}\n          {{#let (eq this.activeIndex index) as |isActive|}}\n            <Menu.Item aria-selected={{isActive}} class={{classes \"d-inline-block\" (if isActive \"active\")}} @onSelect={{fn this.selectOption option index}}>\n              {{option.label}}\n            </Menu.Item>\n          {{/let}}\n        {{else}}\n          <Menu.Item @disabled={{true}}>\n            {{this.noResultsLabel}}\n          </Menu.Item>\n        {{/each}}\n      </:menu>\n    </Dropdown>\n  ", {
      strictMode: true,
      scope: () => ({
        Dropdown,
