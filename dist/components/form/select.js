...
class Select extends BoundValue {
  ...
  get defaultText() {
    return this.args.defaultText ?? this.intl.t(this.args.defaultTextKey ?? 'nrg.select.defaultText');
  }
  get scrollable() {
  ...
  get noOptionsText() {
    return this.args.noOptionsText ?? this.intl.t(this.args.noOptionsTextKey ?? 'nrg.select.noOptions');
  }
  selectItemBySearch() {
