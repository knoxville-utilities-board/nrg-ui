...
class Field extends Component {
  ...
  #hasText = (i(this, "hasText"), undefined);
  static {
    g(this.prototype, "fieldId", [tracked], function () {
      return crypto.randomUUID();
    });
  }
  #fieldId = (i(this, "fieldId"), undefined);
  static {
    g(this.prototype, "messageId", [tracked], function () {
      return crypto.randomUUID();
    });
  }
  #messageId = (i(this, "messageId"), undefined);
  static {
    g(this.prototype, "textId", [tracked], function () {
      return crypto.randomUUID();
    });
  }
  #textId = (i(this, "textId"), undefined);
  requiredId;
  static {
    g(this.prototype, "binding", [tracked]);
  }
  #binding = (i(this, "binding"), undefined);
  constructor(owner1, args1) {
    super(owner1, args1);
    registerDestructor(this, () => {
