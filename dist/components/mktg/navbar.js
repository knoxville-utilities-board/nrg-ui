...
class NavbarComponent extends Component {
  ...
  get classList() {
    const classes1 = ['collapse', 'navbar-collapse'];
    if (this.isMenuOpen) {
      classes1.push('show');
    }
...
export { NavbarComponent as default };
