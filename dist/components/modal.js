...
class Modal extends Component {
  ...
  static {
    setComponentTemplate(precompileTemplate("\n    <dialog class={{this.classList}} id={{this.dialogId}} {{on \"cancel\" this.onDismiss}} {{on \"close\" this.onClose}} {{onInsert this.onInsert}} {{onUpdate this.onUpdate isOpen=@isOpen}} ...attributes>\n      <div class=\"modal-content\">\n        {{#if this.isDismissible}}\n          <button aria-label={{t \"nrg.base.close\"}} class=\"btn-close\" type=\"button\" {{on \"click\" this.onDismiss}}></button>\n        {{/if}}\n        {{#if (has-block \"header\")}}\n          <div class=\"modal-header\">\n            <h5 class=\"modal-title\">\n              {{yield to=\"header\"}}\n            </h5>\n          </div>\n        {{/if}}\n        <div class=\"modal-body\">\n          {{yield}}\n        </div>\n        {{#if (has-block \"footer\")}}\n          <div class=\"modal-footer\">\n            {{yield to=\"footer\"}}\n          </div>\n        {{/if}}\n      </div>\n    </dialog>\n  ", {
      strictMode: true,
      scope: () => ({
        on,
