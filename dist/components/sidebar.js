...
class Item extends Component {
  ...
  static {
    setComponentTemplate(precompileTemplate("\n    {{#if @route}}\n      <LinkTo class={{this.classes}} @route={{@route}} {{on \"click\" this.onClick}} ...attributes>\n        <span>\n          {{yield}}\n        </span>\n        {{#if (has-block \"badge\")}}\n          <span class=\"badge rounded-pill\">\n            {{yield to=\"badge\"}}\n          </span>\n        {{/if}}\n      </LinkTo>\n    {{else if @url}}\n      <a class={{this.classes}} href={{@url}} {{on \"click\" this.onClick}} ...attributes>\n        <span>\n          {{yield}}\n        </span>\n        {{#if (has-block \"badge\")}}\n          <span class=\"badge rounded-pill\">\n            {{yield to=\"badge\"}}\n          </span>\n        {{/if}}\n      </a>\n    {{else}}\n      <div class={{this.classes}} {{!-- @glint-expect-error - Known Glint issue - #661 --}} {{(if @onClick (modifier on \"click\" this.onClick))}} ...attributes>\n        <span>\n          {{yield}}\n        </span>\n        {{#if (has-block \"badge\")}}\n          <span class=\"badge rounded-pill\">\n            {{yield to=\"badge\"}}\n          </span>\n        {{/if}}\n      </div>\n    {{/if}}\n  ", {
      strictMode: true,
      scope: () => ({
        LinkTo,
        on
...
class Group extends Component {
  ...
  static {
    setComponentTemplate(precompileTemplate("\n    {{#if (has-block \"header\")}}\n      {{#if @route}}\n        <LinkTo class={{this.classes}} @disabled={{@disabled}} @route={{@route}} {{on \"click\" this.onClick}} ...attributes>\n          <span>\n            {{yield to=\"header\"}}\n          </span>\n          {{#if (has-block \"badge\")}}\n            <span class=\"badge rounded-pill\">\n              {{yield to=\"badge\"}}\n            </span>\n          {{/if}}\n        </LinkTo>\n      {{else if @url}}\n        <a class={{this.classes}} href={{@url}} disabled={{@disabled}} {{on \"click\" this.onClick}} ...attributes>\n          <span>\n            {{yield to=\"header\"}}\n          </span>\n          {{#if (has-block \"badge\")}}\n            <span class=\"badge rounded-pill\">\n              {{yield to=\"badge\"}}\n            </span>\n          {{/if}}\n        </a>\n      {{else}}\n        <div class={{this.classes}} {{!-- @glint-expect-error - Known Glint issue - #661 --}} {{(if @onClick (modifier on \"click\" this.onClick))}} ...attributes>\n          <span>\n            {{yield to=\"header\"}}\n          </span>\n          {{#if (has-block \"badge\")}}\n            <span class=\"badge rounded-pill\">\n              {{yield to=\"badge\"}}\n            </span>\n          {{/if}}\n        </div>\n      {{/if}}\n    {{/if}}\n    {{#if (has-block \"items\")}}\n      {{yield (component Item onClickInternal=@onClickInternal) to=\"items\"}}\n    {{/if}}\n  ", {
      strictMode: true,
      scope: () => ({
        LinkTo,
        on,
