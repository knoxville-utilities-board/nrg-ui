...
import Classes from '../modifiers/classes.js';
...
class Popover extends Component {
  ...
  static {
    setComponentTemplate(precompileTemplate("\n    {{#let (hash show=this.show hide=this.hide toggle=this.toggle) as |actions|}}\n      {{yield actions to=\"control\"}}\n      <div id={{this.id}} {{classes (unless this.isShown \"hidden\") (concat \"popover bs-popover-\" this.side)}} {{onInsert this.initPopover}} {{!-- @glint-expect-error Modifier types are currently not correct --}} {{onUpdate this.showPopover @alignment @arrow @controlElement @offset @side}} ...attributes>\n        {{#if (has-block-params \"content\")}}\n          {{yield (hash Header=(component Header) Body=(component Body)) actions to=\"content\"}}\n        {{else}}\n          {{yield to=\"content\"}}\n        {{/if}}\n        {{#if this.hasArrow}}\n          <div class=\"popover-arrow\" {{onInsert this.setArrow}}></div>\n        {{/if}}\n      </div>\n    {{/let}}\n  ", {
      strictMode: true,
      scope: () => ({
        hash,
        classes: Classes,
