...
class NumberValidator extends BaseValidator {
  ...
  validate(value, options) {
    ...
    if (isEmpty(value)) {
      return {
        key: 'nrg.validation.number.notANumber'
      };
    }
    ...
    if (integer && !Number.isInteger(numValue)) {
      return {
        key: 'nrg.validation.number.integer'
      };
    }
  ...
  handleOptions(value, options) {
    ...
    if (positive && !isPositive(value)) {
      return {
        key: 'nrg.validation.number.positive'
      };
    }
    if (negative && !isNegative(value)) {
      return {
        key: 'nrg.validation.number.negative'
      };
    }
    if (even && !isEven(value)) {
      return {
        key: 'nrg.validation.number.even'
      };
    }
    if (odd && !isOdd(value)) {
      return {
        key: 'nrg.validation.number.odd'
      };
    }
    const multipleOf = options['multipleOf'];
    if (multipleOf && !isMultipleOf(value, multipleOf)) {
      return {
        key: 'nrg.validation.number.multipleOf',
        multipleOf
      };
    }
    const isValue = is;
    if (isValue !== undefined && value !== isValue) {
      return {
        key: 'nrg.validation.number.isValue',
        isValue
      };
    }
